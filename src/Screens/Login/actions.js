  ...
  return (dispatch) => {
    if (forUpdate?.value) {
      ...
      axios
        ...
        .then((response) => {
          console.log("jgchgvvvvvvvvvvvvvvvvvvvvvvvv", response.data.token)
          let tmp;
          if (response.data.hassuccessed === false) {
            ...
            axios
              .post(
                ...
                commonHeader(response.data.token)
              )
              .then((response2) => {
                if (response2.data.hassuccessed) {
                  ...
                  SendCallback();
                  console.log("2")
                  // this.history.push('/video_register');
                //  return <Redirect to="/video_register" />
                }
              });
